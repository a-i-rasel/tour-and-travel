        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Get In Touch</h5>
                    <p class="mb-4">Tourist erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos</p>
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">123 Street, Badda, Dhaka</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-4">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                ...
                <?php
                    ...
                    if(isset($_POST["submi"])){
                        ...
                        echo '<script>alert("We recive your message!\nThanks for reaching us")</script>';
                    }
                ?>
                <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    <form action="" method="post">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button class="btn btn-primary w-100 py-3" type="submit" name="submi">Send Message</button>
                            </div>
                        </div>
                    </form>
                </div>
